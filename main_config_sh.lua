...
KARSIKIN_MODELS = {"models/wk/jackswan/scion/scion.mdl","models/wk/jackswan/scion/scion_tempestor_lumena.mdl"}
KARSKIN_OFFICER = {"models/wk/jackswan/scion/scion_tempestor.mdl","models/wk/jackswan/scion/scion_tempestor_prime.mdl"}
